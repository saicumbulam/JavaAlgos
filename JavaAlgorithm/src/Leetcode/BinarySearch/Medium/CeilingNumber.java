/*
1. This is a normal binary search.
2. The ceil is updated only when arr[mid] > target and ceil is arr[mid]
3. The floor is updated only when arr[mid] < target and floor is arr[mid]
* */
...
public class CeilingNumber {
    public static void main(String[] args) {
        int[] arr = {1, 2, 3, 5, 7};
        int key = 4;
        System.out.println(findCeiling(arr, key));
    }
